  ...
  theme: {
    extend: {
      colors: {
        ...
        "color-schemes-color-scheme-2-accent":
          "var(--color-schemes-color-scheme-2-accent)",
        "color-schemes-color-scheme-2-border":
          "var(--color-schemes-color-scheme-2-border)",
        "color-schemes-color-scheme-2-foreground":
          "var(--color-schemes-color-scheme-2-foreground)",
        grey: "var(--grey)",
        "primitives-color-blue-gem": "var(--primitives-color-blue-gem)",
        "primitives-color-blue-gem-dark":
          "var(--primitives-color-blue-gem-dark)",
        "primitives-color-blue-gem-darker":
          "var(--primitives-color-blue-gem-darker)",
        "primitives-color-blue-gem-darkest":
          "var(--primitives-color-blue-gem-darkest)",
        "primitives-color-blue-gem-light":
          "var(--primitives-color-blue-gem-light)",
        "primitives-color-blue-gem-lighter":
          "var(--primitives-color-blue-gem-lighter)",
        "primitives-color-blue-gem-lightest":
          "var(--primitives-color-blue-gem-lightest)",
        "primitives-color-jaguar-dark": "var(--primitives-color-jaguar-dark)",
        "primitives-color-jaguar-darker":
          "var(--primitives-color-jaguar-darker)",
        "primitives-color-jaguar-darkest":
          "var(--primitives-color-jaguar-darkest)",
        "primitives-color-jaguar-light": "var(--primitives-color-jaguar-light)",
        "primitives-color-jaguar-lighter":
          "var(--primitives-color-jaguar-lighter)",
        "primitives-color-jaguar-lightest":
          "var(--primitives-color-jaguar-lightest)",

...
export const FooterSection = () => {
  return (
    <footer className="w-full py-20 px-[var(--spacing-sizing-page-padding-padding-global)] bg-color-schemes-color-scheme-1-background">
      <div className="flex flex-col max-w-[var(--spacing-sizing-container-container-large)] mx-auto gap-20 w-full">
        ...
        <div className="flex items-center gap-8 w-full">
          ...
          <nav className="flex items-center gap-8">
            {navLinks.map((link, index) => (
              <Link
                key={index}
                className="font-text-small-semi-bold text-[length:var(--text-small-semi-bold-font-size)] leading-[var(--text-small-semi-bold-line-height)] tracking-[var(--text-small-semi-bold-letter-spacing)] text-[color:var(--color-schemes-color-scheme-1-text)]"
                to={link.path}
              >
                {link.text}
              </Link>
        ...
        <div className="flex flex-col items-center gap-8 w-full">
          ...
          <div className="flex items-center gap-6">
            <p className="font-text-small-normal text-[color:var(--color-schemes-color-scheme-1-text)] text-[length:var(--text-small-normal-font-size)] tracking-[var(--text-small-normal-letter-spacing)] leading-[var(--text-small-normal-line-height)]">

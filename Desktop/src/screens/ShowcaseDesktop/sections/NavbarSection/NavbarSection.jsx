...
export const NavbarSection = () => {
  ...
  const navLinks = [
    ...
    { title: "About Us", href: "/about-us-u8226-desktop", external: false },
    {
      title: "Companies & Solutions",
      href: "/companies-and-solutions-u8226-desktop",
      external: false,
    },
  ];
                  ...
                  <NavigationMenuItem key={index}>
                    {link.external ? (
                      <a
                        ...
                        target="_blank"
                        className="text-[color:var(--color-schemes-color-scheme-1-text)] font-text-regular-normal text-[length:var(--text-regular-normal-font-size)] leading-[var(--text-regular-normal-line-height)] tracking-[var(--text-regular-normal-letter-spacing)] [font-style:var(--text-regular-normal-font-style)]"
                      >
                        {link.title}
                      </a>
                    ) : (

  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start gap-2.5 px-[var(--spacing-sizing-page-padding-padding-global)] pt-4 pb-6 relative self-stretch w-full">
        <nav className="flex flex-col items-center relative self-stretch w-full">
          {navItems.map((item, index) =>
            item.external ? (
              <a
                ...
                target="_blank"
              >
                <div className="w-fit mt-[-1.00px] font-text-medium-normal text-[color:var(--color-schemes-color-scheme-1-text)] text-[length:var(--text-medium-normal-font-size)] tracking-[var(--text-medium-normal-letter-spacing)] leading-[var(--text-medium-normal-line-height)] whitespace-nowrap">
                  {item.title}
                </div>
              </a>
            ) : (
          ...
          <Button
            ...
            className={`h-auto py-2 ${
              button.variant === "outline"
                ? "w-[124px] border-2 border-solid border-[color:var(--primitives-color-neutral-darkest)] bg-primitives-opacity-transparent text-[color:var(--primitives-color-neutral-darkest)]"
                : "w-[120px] bg-primitives-color-blue-gem text-[color:var(--primitives-color-white)] shadow-[0px_1px_2px_#0000000d,inset_0px_-2px_1px_#00000033,inset_0px_0px_0px_1px_#00000026,inset_0px_2px_1px_#ffffff40,inset_0px_32px_24px_#ffffff0d]"
            } rounded-[100px]`}
          >
            <Link to={button.href}>
              <span className="font-text-regular-medium font-[number:var(--text-regular-medium-font-weight)] text-[length:var(--text-regular-medium-font-size)] tracking-[var(--text-regular-medium-letter-spacing)] leading-[var(--text-regular-medium-line-height)] whitespace-nowrap">
                {button.title}
              </span>
            </Link>
          </Button>

...
export const CallToActionSection = () => {
  return (
    ...
    >
      <Card className="border-none shadow-none bg-transparent max-w-[var(--spacing-sizing-container-container-large)] mx-auto">
        <CardContent className="flex flex-col items-center gap-12 p-0">
          <div className="flex flex-col items-center gap-6 w-full max-w-[var(--spacing-sizing-max-width-max-width-large)]">
            ...
            <div className="flex flex-row gap-4">
              <Button
                asChild
                className="px-6 py-2.5 h-auto bg-primitives-color-blue-gem rounded-[100px] shadow-[0px_1px_2px_#0000000d,inset_0px_-2px_1px_#00000033,inset_0px_0px_0px_1px_#00000026,inset_0px_2px_1px_#ffffff40,inset_0px_32px_24px_#ffffff0d]"
              >
              ...
              <Button
                asChild
                variant="outline"
                className="px-6 py-2.5 h-auto rounded-[100px] border-2 border-solid border-[color:var(--primitives-color-neutral-darkest)] bg-primitives-opacity-transparent"
              >
                <Link to="/about-us-u8226-mobile">

        ...
        <div className="flex flex-col items-center gap-12 w-full">
          ...
          <nav className="flex flex-col items-center gap-6 w-full">
            {navLinks.map((link, index) => (
              <Link
                key={index}
                className="font-text-small-semi-bold text-[color:var(--color-schemes-color-scheme-1-text)] text-[length:var(--text-small-semi-bold-font-size)] text-center tracking-[var(--text-small-semi-bold-letter-spacing)] leading-[var(--text-small-semi-bold-line-height)] block w-full"
                to={link.path}
              >
                {link.text}
              </Link>
        ...
        <div className="flex flex-col items-center gap-6 pb-4 w-full">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-4">
              <a
                href="#"
                className="font-text-small-link text-[color:var(--color-schemes-color-scheme-1-text)] text-[length:var(--text-small-link-font-size)] tracking-[var(--text-small-link-letter-spacing)] leading-[var(--text-small-link-line-height)] underline"
              >
                Terms of Service
              </a>
            </div>

            <div className="font-text-small-normal text-[color:var(--color-schemes-color-scheme-1-text)] text-[length:var(--text-small-normal-font-size)] tracking-[var(--text-small-normal-letter-spacing)] leading-[var(--text-small-normal-line-height)]">

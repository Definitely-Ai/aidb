      ...
      <div className="flex flex-col max-w-[var(--spacing-sizing-container-container-large)] mx-auto gap-20 w-full">
          ...
          <div className="flex-1">
            <div className="relative w-[84px] h-9">
              <img
                ...
                src="/img/chatgpt-image-jun-3-2025-02-28-23-pm-1-5.png"
              />
            </div>
          </div>
        ...
        <div className="flex flex-col items-center gap-8 w-full">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="font-text-small-link text-[length:var(--text-small-link-font-size)] tracking-[var(--text-small-link-letter-spacing)] leading-[var(--text-small-link-line-height)] text-[color:var(--color-schemes-color-scheme-1-text)] underline">
              Terms of Service
            </button>
          </div>
        </div>

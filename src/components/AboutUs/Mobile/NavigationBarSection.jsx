...
const NavigationBarSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex h-16 items-center justify-between pl-[var(--spacing-sizing-page-padding-padding-global)] pr-3 py-0 relative self-stretch w-full">
          ...
          {navItems.map((item, index) =>
            item.external ? (
              <a
                ...
                target="_blank"
              >
                <div className="w-fit mt-[-1.00px] font-text-medium-normal text-[color:var(--color-schemes-color-scheme-1-text)] text-[length:var(--text-medium-normal-font-size)] tracking-[var(--text-medium-normal-letter-spacing)] leading-[var(--text-medium-normal-line-height)] whitespace-nowrap [font-style:var(--text-medium-normal-font-style)]">
                  {item.title}
                </div>
              </a>
            ) : (
